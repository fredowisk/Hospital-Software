 ...
 * @author fredaum
 */
public class ViewAlterarPaciente1 extends javax.swing.JFrame {

    /**
     * Creates new form ViewAlterarPaciente1
     */
    public ViewAlterarPaciente1() {
        initComponents();
    }
    ...
    public void Pesquisar(String cpf){
        ...
        for(Paciente p: dao.readSelectedPacienteCpf(cpf)){
            txtNome.setText(p.getNome());
            txtCelular.setText(p.getTelefone());
            txtCPF.setText(p.getCpf());
            txtSus.setText(p.getSus());            
            jSexo.setSelectedItem(p.getSexo());
            }
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ViewAlterarPaciente1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ViewAlterarPaciente1().setVisible(true);
            }
        });
    }
