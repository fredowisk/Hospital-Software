 ...
 * @author fredaum
 */
public class ViewAlterarMedico1 extends javax.swing.JFrame {

    /** Creates new form ViewAlterarMedico1 */
    public ViewAlterarMedico1() {
        initComponents();
    }
    public void Pesquisar(String cpf){
    MedicoDAO dao = new MedicoDAO();
        //Setando as linhas com os itens no banco de dados.
        for(Medico m: dao.readSelectedMedicoCpf(cpf)){
            txtNome.setText(m.getNome());
            txtCelular.setText(m.getTelefone());
            txtCPF.setText(m.getCpf());
            txtSus.setText(m.getSus());            
            jSexo.setSelectedItem(m.getSexo());
            }
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ViewAlterarMedico1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ViewAlterarMedico1().setVisible(true);
            }
        });
    }
