 ...
 * @author fredaum
 */
public class ViewAtendimentoMedico extends javax.swing.JInternalFrame {

    /**
     * Creates new form ViewAtendimentoMedico
     */
    public ViewAtendimentoMedico() {
        initComponents();
    ...
    public void readJTable(){
        ...
        for(Paciente p: dao.readNaoAtendidos()){
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Nome completo", "Nascimento", "Telefone", "CPF", "SUS", "Sexo"
            }
        ) {
        ...
        btnFinalizado.setBackground(new java.awt.Color(31, 31, 31));
        btnFinalizado.setFont(new java.awt.Font("Ubuntu", 1, 15)); // NOI18N
        btnFinalizado.setForeground(new java.awt.Color(254, 254, 254));
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                ...
                .addComponent(btnFinalizado, javax.swing.GroupLayout.PREFERRED_SIZE, 103, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(35, 35, 35)
    ...
    private void btnFinalizadoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnFinalizadoActionPerformed
        ...
        p.setAtendido(JOptionPane.showInputDialog(null, "Este paciente foi atendido ?"));
        if(p.getAtendido().equals("N")|| p.getAtendido().equals("S")){
        dao.updateAtendido(p);
        
        readJTable();
        } else {
            JOptionPane.showMessageDialog(null, "Responda apenas com S ou N!");
        }
